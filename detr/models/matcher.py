...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        """
        # print("HungarianMatcher.forward start")
        out_centroid = outputs["pred_centroids"].flatten(0, 1)  # [batch_size * num_queries, 2]

        tgt_centroid = torch.cat([v["centroids"] for v in targets])

        # Compute the L1 cost between centroids
        cost_centroid = torch.cdist(out_centroid, tgt_centroid, p=1)

        # print("HungarianMatcher.forward end")
